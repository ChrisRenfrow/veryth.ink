...
The source is freely available for reference (unlicensed at the moment) and can be found [on GitHub](https://github.com/ChrisRenfrow/20gc-jetpack-joyride).
