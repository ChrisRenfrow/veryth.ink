...
<EmbedImage
  src={import("./very-think-favicon-light-upscaled.png")}
  alt="Pixel art of a brain as viewed from the top with a 'repeat track' symbol in the middle of the two hemispheres"
  width="1/2"
/>
