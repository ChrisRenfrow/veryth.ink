...
<EmbedImage
    src={import("./bevy-card-1.gif")}
    alt="A white rectangle against a black background following a mouse pointer"
    caption="Success!"
/>

You can check out the source [here](https://github.com/livviest/bevy-cards/commit/c8f5857e63e78d18bb53a9e1b1295d5f8d568fa2), but the core of this simple functionality lies in this system:
...
Here is [the commit](https://github.com/livviest/bevy-cards/commit/6367efe281a736ea9e4160655de939401842ba9e) so you can see what changed.
