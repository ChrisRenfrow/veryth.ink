:PROPERTIES:
:header-args: :tangle (concat (file-name-sans-extension buffer-file-name) ".md") :comments no
:END:
...
#+begin_src markdown
In which I re-discover the motivation to write in my blog, by writing about how I haven't written in my blog.
